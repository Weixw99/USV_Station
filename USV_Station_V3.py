...
class MySignals(QObject):
    ...
    update_video = pyqtSignal()
    update_usv_message = pyqtSignal()


class Asknum(QMainWindow):  # 一开始的数量和ip地址采集
    def __init__(self):
        global vehicle_num
        super().__init__()
...
class SubWindow_p(QMainWindow):  # 设置参数的窗口
    def __init__(self):
        global vehicle_num
        super().__init__()
...
class SubWindow(QMainWindow):  # 状态监控
    def __init__(self):
        global vehicle_num
        super().__init__()
        ...
        self.texts = [
            ...
            self.ui.text_11]
        self.pas = [
            [self.ui.pa0_0, self.ui.pa1_0, self.ui.pa2_0, self.ui.pa3_0, self.ui.pa4_0, self.ui.pa5_0, self.ui.pa6_0,
             self.ui.pa7_0, self.ui.pa8_0, self.ui.pa9_0, self.ui.pa10_0, self.ui.pa11_0],
            [self.ui.pa0_1, self.ui.pa1_1, self.ui.pa2_1, self.ui.pa3_1, self.ui.pa4_1, self.ui.pa5_1, self.ui.pa6_1,
             self.ui.pa7_1, self.ui.pa8_1, self.ui.pa9_1, self.ui.pa10_1, self.ui.pa11_1],
            [self.ui.pa0_2, self.ui.pa1_2, self.ui.pa2_2, self.ui.pa3_2, self.ui.pa4_2, self.ui.pa5_2, self.ui.pa6_2,
             self.ui.pa7_2, self.ui.pa8_2, self.ui.pa9_2, self.ui.pa10_2, self.ui.pa11_2],
            [self.ui.pa0_3, self.ui.pa1_3, self.ui.pa2_3, self.ui.pa3_3, self.ui.pa4_3, self.ui.pa5_3, self.ui.pa6_3,
             self.ui.pa7_3, self.ui.pa8_3, self.ui.pa9_3, self.ui.pa10_3, self.ui.pa11_3],
            [self.ui.pa0_4, self.ui.pa1_4, self.ui.pa2_4, self.ui.pa3_4, self.ui.pa4_4, self.ui.pa5_4, self.ui.pa6_4,
             self.ui.pa7_4, self.ui.pa8_4, self.ui.pa9_4, self.ui.pa10_4, self.ui.pa11_4],
            [self.ui.pa0_5, self.ui.pa1_5, self.ui.pa2_5, self.ui.pa3_5, self.ui.pa4_5, self.ui.pa5_5, self.ui.pa6_5,
             self.ui.pa7_5, self.ui.pa8_5, self.ui.pa9_5, self.ui.pa10_5, self.ui.pa11_5],
            [self.ui.pa0_6, self.ui.pa1_6, self.ui.pa2_6, self.ui.pa3_6, self.ui.pa4_6, self.ui.pa5_6, self.ui.pa6_6,
             self.ui.pa7_6, self.ui.pa8_6, self.ui.pa9_6, self.ui.pa10_6, self.ui.pa11_6],
            [self.ui.pa0_7, self.ui.pa1_7, self.ui.pa2_7, self.ui.pa3_7, self.ui.pa4_7, self.ui.pa5_7, self.ui.pa6_7,
             self.ui.pa7_7, self.ui.pa8_7, self.ui.pa9_7, self.ui.pa10_7, self.ui.pa11_7],
            [self.ui.pa0_8, self.ui.pa1_8, self.ui.pa2_8, self.ui.pa3_8, self.ui.pa4_8, self.ui.pa5_8, self.ui.pa6_8,
             self.ui.pa7_8, self.ui.pa8_8, self.ui.pa9_8, self.ui.pa10_8, self.ui.pa11_8],
            [self.ui.pa0_9, self.ui.pa1_9, self.ui.pa2_9, self.ui.pa3_9, self.ui.pa4_9, self.ui.pa5_9, self.ui.pa6_9,
             self.ui.pa7_9, self.ui.pa8_9, self.ui.pa9_9, self.ui.pa10_9, self.ui.pa11_9],
            [self.ui.pa0_10, self.ui.pa1_10, self.ui.pa2_10, self.ui.pa3_10, self.ui.pa4_10, self.ui.pa5_10,
             self.ui.pa6_10, self.ui.pa7_10, self.ui.pa8_10, self.ui.pa9_10, self.ui.pa10_10, self.ui.pa11_10],
            [self.ui.pa0_11, self.ui.pa1_11, self.ui.pa2_11, self.ui.pa3_11, self.ui.pa4_11, self.ui.pa5_11,
             self.ui.pa6_11, self.ui.pa7_11, self.ui.pa8_11, self.ui.pa9_11, self.ui.pa10_11, self.ui.pa11_11]]
        self.sets = [
            self.ui.set_0,
            self.ui.set_1,
            self.ui.set_2,
...
class MainWindow(QMainWindow):  # 主界面
    def __init__(self):
        ...
        self.color = ["red", 'blue', "magenta", "green", "black", "white", "cyan", 'darkblue', "yellow","coral","brown","pink"]
        ...
        self.ms.update_usv_message.connect(self.update_usv_message)

        self.ui.home_lat.setPlaceholderText("lat")
        self.ui.home_lon.setPlaceholderText("lon")
        self.ui.home_num.setPlaceholderText("0")
        ...
        self.ui.setplot1.clicked.connect(self.plot1_start)
        self.ui.setplot2.clicked.connect(self.plot2_start)
        # self.ui.setplot1_clear.clicked.connect(self.plot1_sth_clear)
        # self.ui.setplot2_clear.clicked.connect(self.plot2_sth_clear)       
        ...
        self.update_message_start()
        self.data1 = [[] for i in range(vehicle_num+1)]
        self.data2 = [[] for i in range(vehicle_num+1)]

        self.ui.plot1.setBackground('w')
        self.ui.plot1.showGrid(x=True, y=True, alpha=0.3)
        self.ui.plot2.setBackground('w')
        self.ui.plot2.showGrid(x=True, y=True, alpha=0.3)

        self.texts = [
            self.ui.message_usv0,
            self.ui.message_usv1,
            self.ui.message_usv2]

    def update_usv_message(self):
        global vehicle_num
        global locations_global
        global locations_local
        global speeds
    ...
    def update_message_start(self):
        def update_message_thread():
            while 1:
                self.ms.update_usv_message.emit()
                time.sleep(0.25)
        t = Thread(target=update_message_thread)
        t.start()
    ...
    def plot1_sth(self):
        ...
        global moment1
        global vehicle_num
        if self.ui.curve_data1.text() != '':            
            try:
                self.data1[0].append(moment1)
                numb1 = name[self.ui.curve_data1.text()]
                for i in range(vehicle_num):
                    self.data1[i+1].append(numb1[i])
                    self.ui.plot1.plot(self.data1[0], self.data1[i+1], pen=self.color[i])
                return False
            except:
                self.ui.message.append(str(self.ui.curve_data1.text()) + '设置错误')
                return True

    def plot1_start(self):
        if self.ui.curve_data1.text() != '':
            def plot1_thread():
                while 1:
                    done = self.plot1_sth()
                    ...
                    if done:
                        break
            t = Thread(target=plot1_thread)
            t.start()

    # def plot1_sth_clear(self):
    #     self.data1.clear()

    def plot2_sth(self):
        global name
        global moment1
        if self.ui.curve_data2.text() != '':
            try:
                self.data2[0].append(moment1)
                numb2 = name[self.ui.curve_data2.text()]
                for i in range(vehicle_num):
                    self.data2[i+1].append(numb2[i])
                    self.ui.plot2.plot(self.data2[0],self.data2[i+1], pen=self.color[i])
                return False
            except:
                self.ui.message.append(str(self.ui.curve_data2.text()) + '设置错误')
                return True

    def plot2_start(self):
        if self.ui.curve_data2.text() != '':
            def plot2_thread():
                while 1:
                    done = self.plot2_sth()
                    ...
                    if done:
                        break
            t = Thread(target=plot2_thread)
            t.start()

    # def plot2_sth_clear(self):
    #     self.data2.clear()
                ...
                if newSockets[i] != 0:
                    try:
                        ...
                        self.ui.message.append(
                            str(i) + '号船设定原点：' + '[' + self.ui.home_lat.text() + self.ui.home_lon.text() + ']')
                    except:
                        self.ui.message.append(str(i) + '号船设置原点错误')
            self.ui.webview.page().runJavaScript(
                "set_home_new({0});".format([float(self.ui.home_lon.text()), float(self.ui.home_lat.text())]))

    def set_home_do_0(self):
        global newSockets
        global locations_global
        if self.ui.home_num.text() != '':
            home_num = int(self.ui.home_num.text())
            message = [1, locations_global[home_num][1], locations_global[home_num][0]]
            message_json = json.dumps(message, ensure_ascii=False)
            for i in range(len(newSockets)):
                if newSockets[i] != 0:
                    try:
                        newSockets[i].send(message_json.encode("utf-8"))
                        self.ui.message.append(
                            str(i) + '号船设定原点：' + '[' + str(locations_global[home_num][1]) + ', ' + str(locations_global[home_num][0]) + ']')
                    except:
                        self.ui.message.append(str(i) + '号船设置原点错误')
            self.ui.webview.page().runJavaScript(
                "set_home_new({0});".format([locations_global[home_num][0], locations_global[home_num][1]]))
...
def send_message(newSocket, clientAddr):  # 发送数据
    global name
    global vehicle_num
    global pa
    global dva
...
def build_variables(newSocket, clientAddr):  # 接受数据
    global name
    global vehicle_num
    global pa
    global dva
